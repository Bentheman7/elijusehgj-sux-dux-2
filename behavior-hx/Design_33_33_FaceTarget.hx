...
class Design_33_33_FaceTarget extends ActorScript
{          	
...
if(wrapper.enabled)
{
        if(((hasValue(_TargetActor) != false) && _TargetActor.isAlive()))
{
...
propertyChanged("_DistanceY", _DistanceY);
            actor.setAngle(Utils.RAD * ((Utils.DEG * (Math.atan2(_DistanceY, _DistanceX)) - _Facing)));
}
