...
class Design_17_17_DieinPit extends ActorScript
{          	
	
public var _FadeTime:Float;

public var _TimeBeforeReload:Float;
    public function _customEvent_healthDepleated():Void
{
        if(actor.isBehaviorEnabled("Spawn Actor Upon Death"))
{
            actor.disableBehavior("Spawn Actor Upon Death");
            runLater(1000 * _TimeBeforeReload, function(timeTask:TimedTask):Void {
